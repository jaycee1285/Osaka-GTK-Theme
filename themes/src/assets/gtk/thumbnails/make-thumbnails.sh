...
for theme in '' '-Blue' '-Green' '-Grey' '-Orange' '-Pink' '-Purple' '-Red' '-Teal' '-Yellow'; do
    for type in '' '-Solarized'; do
        ...
        if [[ "$type" != '' ]]; then
            ...
            sed -i "s/#fdf5e2/${background_light}/g" "thumbnail${theme}${type}.svg"
            sed -i "s/#001419/${background_dark}/g" "thumbnail${theme}${type}.svg"
            ...
            sed -i "s/#1a6397/${theme_color_light}/g" "thumbnail${theme}.svg"
